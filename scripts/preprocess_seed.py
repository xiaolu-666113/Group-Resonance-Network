#!/usr/bin/env python3
"""Preprocess raw SEED EEG into cached DE features."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Preprocess raw SEED data")
    parser.add_argument("--input", type=str, required=True, help="Raw SEED npz path")
...
def main() -> None:
    ...
    print(f"Saved preprocessed SEED features to: {out}")
